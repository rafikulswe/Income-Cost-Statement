                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card bootstrap-iso">
                            <form class="form-horizontal" method="post" action="{{route('lender.update', [$lender->id])}}">
                                @method('PUT')
                                {{csrf_field()}}
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="add_admin_info">
                                            <div class="form-group{{ $errors->has('lender_name') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" name="lender_name" class="form-control input_field" id="lender_name" value="{{$lender->lender_name}}">
                                            ...
                                            <div class="form-group{{ $errors->has('lender_phone') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" name="lender_phone" class="form-control input_field" id="lender_phone" value="{{$lender->lender_phone}}">
                                                    <span class="help-block">
                                            ...
                                            <div class="form-group{{ $errors->has('lender_email') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="email" name="lender_email" class="form-control input_field" id="lender_email" value="{{$lender->lender_email}}" kl_virtual_keyboard_secure_input="on" data-fv-regexp="true" data-fv-regexp-regexp="^[0-9+\s\.]+$" data-fv-regexp-message="Amount can consist of number only">
                                                    <span class="help-block">
                                            ...
                                            <div class="form-group{{ $errors->has('lender_remarks') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-sm-6">
                                                    <textarea name="lender_remarks" class="form-control input_field" id="lender_remarks" cols="30" rows="2">{{$lender->lender_remarks}}</textarea>
                                                    <span class="help-block">
