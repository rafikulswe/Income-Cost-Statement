            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card bootstrap-iso">
                        <form class="form-horizontal" method="post" action="{{route('todoList.update', [$todo->id])}}">
                            @method('PUT')
                            {{csrf_field()}}
                                ...
                                <div class="panel-body">
                                    <div class="add_admin_info">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="title" class="form-control input_field" id="" value="{{$todo->title}}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="tinytextarea" class="col-sm-3 control-label">Note</label>
                                            <div class="col-sm-8">
                                                <textarea name="note" class="form-control input_field" id="tinytextarea" cols="30" rows="2">{{$todo->note}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
