                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="add_admin_info">
                                            <div class="form-group{{ $errors->has('expense_category_id') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-sm-4">
                                                    <select class="form-control selbox" name="expense_category_id">
                                                        ...
                                                        <option @if($category->id == $expense->expense_category_id) selected @endif value="{{$category->id}}">{{$category->category_name}}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="form-group{{ $errors->has('expense_name') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" name="expense_name" class="form-control input_field" id="expense_name" value="{{$expense->expense_name}}">
                                                    <span class="help-block">
                                            ...
                                            <div class="form-group{{ $errors->has('expense_amount') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" name="expense_amount" class="form-control input_field" id="expense_amount" value="{{$expense->expense_amount}}" kl_virtual_keyboard_secure_input="on" data-fv-regexp="true" data-fv-regexp-regexp="^[0-9+\s\.]+$" data-fv-regexp-message="Amount can consist of number only">
                                                    <span class="help-block">
                                            ...
                                            <div class="form-group{{ $errors->has('expense_date') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" name="expense_date" class="form-control input_field pick_date" id="expense_date" value="{{$expense->expense_date}}">
                                                    <span class="help-block">
                                            ...
                                            <div class="form-group{{ $errors->has('expense_details') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-sm-6">
                                                    <textarea name="expense_details" class="form-control input_field" id="expense_details" cols="30" rows="2">{{$expense->expense_details}}</textarea>
                                                    <span class="help-block">
