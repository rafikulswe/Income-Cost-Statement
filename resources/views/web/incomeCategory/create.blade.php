            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card bootstrap-iso">
                        <form class="form-horizontal" method="post" action="{{url('/incomeCategory')}}">
                            {{csrf_field()}}
                            <div class="panel panel-default">
                                <div class="panel-heading panel_heading_customize">
                                    ...
                                    <div class="col-md-6 text-right padnone padright">
                                        <a href="{{url('/incomeCategory')}}" class="btn btn-info btn-fill btn-sm btnu"><i class="fa fa-th"></i> All Income Category</a>
                                    </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="add_admin_info">
                                        <div class="form-group{{ $errors->has('category_name') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="category_name" class="form-control input_field" id="" value="{{old('category_name')}}">
                                        ...
                                        <div class="form-group{{ $errors->has('category_remarks') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="category_remarks" class="form-control input_field" id="" value="{{old('category_remarks')}}">
                                                <span class="help-block">
