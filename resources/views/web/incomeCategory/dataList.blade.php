...
@section('content')
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <div class="col-md-6 text-right padnone">
                                    <a href="{{url('/incomeCategory/create')}}" class="btn btn-info btn-fill btn-sm btnu"><i class="fa fa-plus-circle"></i> Add Income Category</a>
                                </div>
                                    ...
                                    <table id="alltableinfo" class="table table-striped table-bordered table_customize">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{url('/incomeCategory/'.$category->id)}}"><i class="fa fa-plus-square fa-lg man_view"></i></a>
                                                    <a href="{{url('/incomeCategory/'.$category->id.'/edit/')}}"><i class="fa fa-edit fa-lg man_edit"></i></a>
    ...
    <div class="modal fade" id="mySoftDelete" tabindex="-1" role="dialog" aria-labelledby="mySoftDeleteLabel">
        ...
        <form method="post" action="{{url('/incomeCategory/'.@$category->id)}}">
            @method('DELETE')
            {{csrf_field()}}
