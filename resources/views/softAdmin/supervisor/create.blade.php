                ...
                <div class="col-xs-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            @endif
                            <form class="form-horizontal form-bordered" action="{{route('admin.saveSupervisor')}}" method="POST">
                                @csrf
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="generate_emp_id">Employee ID</label>
                                    <div class="col-md-6">
                                        <input type="hidden" name="generate_emp_id" class="form-control" id="generate_emp_id" value="{{$generate_emp_id}}"/>
                                        <input type="text" disabled name="generate_emp_id" class="form-control" id="generate_emp_id" value="{{$generate_emp_id}}" required/>
                                    </div>
                                </div>
                                <div class="form-group">
